...
public class McpConfig {
    ...
    @Bean
    public ToolCallbackProvider addressToolCallbackProvider(AddressService addressService, PersonService personService) {
        return MethodToolCallbackProvider.builder().toolObjects(addressService,personService).build();
    }
}